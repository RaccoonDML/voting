...
const contract_id = {
  ...
  txId: "e1364a8df28d4c031a84d199511068e334bf4fdc0511fcc6f42eff5630d1c467",
  /** The output index */
  outputIndex: 0,
};
    ...
    <div className="App">
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="center">DanMao</TableCell>
              <TableCell align="center">Kopoko</TableCell>
              <TableCell align="center">Wonderpal</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"danmao"}
                    src={`${process.env.PUBLIC_URL}/${"danmao"}.png`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"kpk"}
                    src={`${process.env.PUBLIC_URL}/${"kpk"}.png`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"wd"}
                    src={`${process.env.PUBLIC_URL}/${"wd"}.png`}
                  />
                </Box>
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <Divider orientation="vertical" flexItem />
                <Box>
                  <Typography variant={"h1"}>
                    {votingContract?.candidates[2].votesReceived.toString()}
                  </Typography>
                  <Button
                    variant="text"
                    onClick={voting}
                    name={votingContract?.candidates[2].name}
                  >
                    👍
                  </Button>
                </Box>
